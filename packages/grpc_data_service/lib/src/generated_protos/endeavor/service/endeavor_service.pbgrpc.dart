...
class EndeavorClient extends $grpc.Client {
  static final _$listEndeavors = $grpc.ClientMethod<$0.ListEndeavorsRequest, $0.ListEndeavorsResponse>(
      '/endeavor.service.Endeavor/ListEndeavors',
  ...
  static final _$listEvents = $grpc.ClientMethod<$0.ListEventsRequest, $0.ListEventsResponse>(
      '/endeavor.service.Endeavor/ListEvents',
  ...
  static final _$deleteTask = $grpc.ClientMethod<$0.DeleteTaskRequest, $1.Empty>(
      ...
      ($core.List<$core.int> value) => $1.Empty.fromBuffer(value));
  static final _$createSchedule = $grpc.ClientMethod<$0.CreateScheduleRequest, $1.Empty>(
  ...
  $grpc.ResponseFuture<$0.ListEndeavorsResponse> listEndeavors($0.ListEndeavorsRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listEndeavors, request, options: options);
  }
...
abstract class EndeavorServiceBase extends $grpc.Service {
  ...
  EndeavorServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.DeleteTaskRequest, $1.Empty>(
        ...
        ($1.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.CreateScheduleRequest, $1.Empty>(
        'CreateSchedule',
        createSchedule_Pre,
        false,
        false,
  ...
  $async.Future<$0.ListEndeavorsResponse> listEndeavors_Pre($grpc.ServiceCall call, $async.Future<$0.ListEndeavorsRequest> request) async {
    return listEndeavors(call, await request);
  }
  ...
  $async.Future<$1.Empty> createSchedule_Pre($grpc.ServiceCall call, $async.Future<$0.CreateScheduleRequest> request) async {
